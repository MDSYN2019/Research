...
int main () {
  ...
  for (i=15.0;i<=30.0;i+=0.01) {     
    Pe = 0;
    r = i;
    printf("%i %f %lf %.15lf \n",a, i, Upp(i-15.0, 15.0 , 4.5060, 0.42, P(i,15.0))+29.566098, (Upp(i-15.0, 15.0, 4.5060 ,0.42,P(i+0.02,15.0)) - Upp(i-15.0,15.0,4.5060,0.42,P(i,15.0)))/0.02);
