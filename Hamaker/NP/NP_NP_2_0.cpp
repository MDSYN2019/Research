...
int main () {
  ...
  for (i=20.0;i<=35.0;i+=0.01) { 
    
    Pe = 0;
    r = i;

    printf("%i %f %lf %.15lf \n",a, i, Upp(i-20.0, 20.0 , 4.5060, 0.42, P(i,20.0)) + 40.200810, (Upp(i-20.0,20.0,4.5060,0.42,P(i+0.02,20.0)) - Upp(i-20.0,20.0,4.5060,0.42,P(i,20.0)))/0.02);
