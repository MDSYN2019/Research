...
/*
  ...
  Normal Classes are bound to the data types specified for their 
  member data. This means hat if we want to store values or objects within that class, we must specify the type of data upfront 
